            ...
            $.ajax({
                        ...
                        success: function(obj) {
                            if (obj == "0") {
                                ...
                                $("#war").slideUp("slow");
                                var str = "<table width='100%'> <thead> <tr> <th>日期</th> <th>日志名称</th> <th>操作</th> </tr> </thead> <tbody>";
                                for (var i = 0; i < obj.length; i++) {
                                    ...
                                    str += "<a href='<%=basePath%>";
                                    str += obj[i]["url"] + "' title=''>";
                                    str += " <img src='img/icons/save_download_32.png' alt='下载'/></a>";
                                    str += "</tr>";
                                }
                                str += "</tbody> </table>";
    ...
    <div class="contentcontainer">
        ...
        <div class="extrabottom">
            <ul>
                ...
                <li><input type="button" onclick="getFile();" c value="查询" class="btn"/></li>
            </ul>

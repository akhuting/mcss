...
<head>
    ...
    <SCRIPT type="text/javascript">
        function getCP() {
            var d = new Date();
            sendAjaxRequest("cp!field.action?type=LiveArea&field=cp&d=" + d.getMilliseconds());
        }
        function getChannel() {
            var d = new Date();
            sendAjax("cp!channel.action?type=LiveArea&field=subtype&d=" + d.getMilliseconds());
        }
    </SCRIPT>
</head>
            ...
            <table width="100%" id="idData">
                ...
                <%
                    ...
                    if (map.get("total") != null) {
                        total = Double.parseDouble(String.valueOf(map.get("total")));
                        if(total == 0){
                            total = 1;
                        }
                    }
                ...
                <tr class=table-row>
                    ...
                    <td><%=formatter.format(Double.parseDouble(String.valueOf(entry.getValue())) / total)%>
                    </td>
                </tr>
                <%
                        }

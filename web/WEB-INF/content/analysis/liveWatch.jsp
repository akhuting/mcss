...
<head>
    ...
    <SCRIPT type="text/javascript">
        function getCP() {
            var d = new Date();
            sendAjaxRequest("cp!field.action?type=LiveWatch&subType=Highest,Lowest&field=cp&d=" + d.getMilliseconds());
        }
        function getChannel() {
            var d = new Date();
            sendAjax("cp!channel.action?type=LiveWatch&subType=Highest,Lowest&field=item&d=" + d.getMilliseconds());
        }
    </SCRIPT>
</head>
            ...
            <table width="100%" id="idData">
                ...
                <%
                    ...
                    for (Object key : key_arr) {
                        if (!key.equals("xml") && !key.equals("type") && !key.equals("data")) {

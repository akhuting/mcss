...
<div id="rightside">
    ...
    <div class="contentcontainer">
        ...
        <div id="content">
            <div id="wrapper">
                <div id="steps">
                    <form id="formElem" name="formElem" action="<%=basePath%>user!regUser.action" method="post">
                        <fieldset class="step">
                            <legend>账户</legend>
                            <p>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="sobey@sobey.com" type="email"
                                       AUTOCOMPLETE=OFF/>
                            </p>

                            <p>
                                <label for="password">密码</label>
                                <input id="password" name="loginpassword" type="password" AUTOCOMPLETE=OFF/>
                            </p>
                        </fieldset>
                        <fieldset class="step">
                            <legend>个人资料</legend>
                            ...
                            <p>
                                ...
                                <input id="phone" name="phone" placeholder="123456789" type="tel"
                                       AUTOCOMPLETE=OFF/>
                            </p>

                            <p>
                                <label for="rank">排名</label>
                                <input id="rank" name="rank" value="0"/>
                            </p>
                        </fieldset>
                        <fieldset class="step">
                            <legend>域名设置</legend>
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                <label>流媒体加速</label>
                                <input style="width: 50px;" onkeyup="checkdig('fmin')" id="fmin"
                                       name="fmin">&nbsp;<input
                        ...
                        <fieldset class="step">
                            ...
                            <p> 如果所有的步骤有一个绿色的对号图标表明所有选项填写正确，
                                一个红色的对号图标表明，有些选项未填写。最后一切填写正确，请点击按钮完成注册 </p>

                            <p class="submit">
                                <button id="registerButton" type="submit" class="regButton">注册</button>
                            </p>

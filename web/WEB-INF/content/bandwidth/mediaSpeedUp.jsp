...
<%@ page import="com.sobey.common.util.MirrorUtil" %>
<%--
...
<head>
    ...
    <SCRIPT type="text/javascript">
        function getCP() {
            var d = new Date();
            sendAjaxRequest("cp!field.action?type=Media&field=cp&table=broadbandstat&d=" + d.getMilliseconds());
        }
    </SCRIPT>
</head>
                ...
                <tr class=table-row>
                    ...
                    <td>
                        <%
                            long count = 0;
                            for (int j = 1; j <= 24; j++) {
                                count += Long.parseLong(MirrorUtil.getValue(Hourstatitem.class, hourstatitem, "count" + j).toString());
                            }
                            out.print(count / 24);
                        %>(Mbps)
                    </td>

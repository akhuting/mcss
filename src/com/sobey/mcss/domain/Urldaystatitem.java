 ...
 */
@javax.persistence.IdClass(UrldaystatitemPK.class)
@Entity
public class Urldaystatitem {
    private String cp;

    @javax.persistence.Column(name = "CP", nullable = false, insertable = true, updatable = true, length = 50, precision = 0)
    @Id
    public String getCp() {
        return cp;
    }
    ...
    @javax.persistence.Column(name = "Count25", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count26", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count27", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count28", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count29", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count30", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    @javax.persistence.Column(name = "Count31", nullable = true, insertable = true, updatable = true, length = 19, precision = 0)
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        Urldaystatitem that = (Urldaystatitem) o;
        ...
        if (count25 != that.count25) return false;
        if (count26 != that.count26) return false;
        if (count27 != that.count27) return false;
        if (count28 != that.count28) return false;
        if (count29 != that.count29) return false;
        if (count3 != that.count3) return false;
        if (count30 != that.count30) return false;
        if (count31 != that.count31) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (count25 ^ (count25 >>> 32));
        result = 31 * result + (int) (count26 ^ (count26 >>> 32));
        result = 31 * result + (int) (count27 ^ (count27 >>> 32));
        result = 31 * result + (int) (count28 ^ (count28 >>> 32));
        result = 31 * result + (int) (count29 ^ (count29 >>> 32));
        result = 31 * result + (int) (count30 ^ (count30 >>> 32));
        result = 31 * result + (int) (count31 ^ (count31 >>> 32));

...
import com.sobey.IPEntry;
import com.sobey.Utils;
...
public class IPUtil {
    ...
    private static final String IP_FILE = IPUtil.class.getResource("/qqwry.dat").toString().substring(6);
    // 一些固定常量，比如记录长度等等
    ...
    private IPUtil() {
        ...
        try {
            ...
            System.out.println(IPUtil.class.getResource("/qqwry.dat").toString());
